...
func (h *ExportHandler) ExportNilai(c *gin.Context) {
	...
	writer := csv.NewWriter(c.Writer)
	writer.Write([]string{"Nama Siswa", "NIS", "DUDI", "Kehadiran (%)", "Alur Bisnis (0-100)", "Soft Skills (0-100)", "Kompetensi Teknis (0-100)", "POS & K3LH (0-100)", "Nilai Akhir", "Grade", "Catatan"})
